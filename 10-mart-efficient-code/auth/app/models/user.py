...
class UserModel(SQLModel, table=True):
    ...
    tokens: Optional[List["UserTokenModel"]] = Relationship(ForwardRef("UserTokenModel") ,back_populates="user")
    orders: Optional[List["OrderPlacedModel"]] = Relationship(ForwardRef("OrderPlacedModel") ,back_populates="user")
    comments: Optional[List["CommentModel"]] = Relationship(ForwardRef("CommentModel") ,back_populates="user")
...
class UserTokenModel(SQLModel, table=True):
    ...
    user: "UserModel" = Relationship(ForwardRef("UserModel") ,back_populates="tokens")
