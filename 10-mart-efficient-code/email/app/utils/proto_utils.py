...
# from app.models.all_models import ProductModel, Email, EmailContent, CompanyModel, CompanyTokenModel, UserModel, UserTokenModel
# from datetime import datetime
# from app.protobuf import all_proto_pb2, email_content_pb2, email_pb2, user_pb2, company_pb2, company_token_pb2, user_token_pb2
# from uuid import UUID
...
# def proto_to_productmodel(product_proto: all_proto_pb2.Product) -> ProductModel:
#     product = ProductModel(
#         id=UUID(product_proto.id),
#         name=product_proto.name,
#         description=product_proto.description or None,
#         category=product_proto.category or None,
